...
const RESOURCES: Record<AppLocale, TranslationTree> = {
  ...
  "fr-CA": {
    ...
    syncCard: {
      syncedCount: "{processed} / {total} photos synchronisees",
      checking: "Verification des nouveaux elements...",
      complete: "Synchronisation terminee",
      ready: "Pret a synchroniser les photos",
      syncing: "Synchronisation...",
      checkingShort: "Verification...",
      checkForNew: "Synchroniser",
    },
    updateNotifier: {
      downloading: "Telechargement de la mise a jour...",
      ready: "La mise a jour {version} est prete",
      restartHint: "Redemarrez pour terminer l'installation.",
      restarting: "Redemarrage...",
      restartNow: "Redemarrer maintenant",
      dismissAria: "Masquer la notification de mise a jour",
    },
    header: {
    ...
    topBar: {
      ...
      selectedCount: "{count} selectionnees",
      delete: "Supprimer",
      archiveConfirmTitle: "Archiver les photos ?",
      archiveConfirmBody:
        "Ceci archivera {count} photo{suffix} selectionnee{suffix}. Vous pourrez les restaurer plus tard.",
      archiveFailed: "Impossible d'archiver les photos",
      archiving: "Archivage...",
      archive: "Archiver",
    },
    photos: {
    ...
    albums: {
      ...
      noAlbumsForFilter: "Aucun album trouve pour ce filtre.",
      albumsCount: "({count} albums)",
    ...
    filters: {
      ...
      noPeopleFound: "Aucune personne trouvee",
      ...
      sortDescending: "Decroissant",
      sortAscending: "Croissant",
    },
    photoGrid: {
      loaded: "{count} charges",
      loadedAll: "{count} charges (tous)",
      jumpToDateAria: "Aller a une date",
      jumpToDate: "Aller à la date",
      loadingMoreAssets: "Chargement de plus d'elements...",
      noMoreAssets: "Aucun autre element a charger.",
      backAria: "Retour",
      ...
      openFullscreenAria: "Ouvrir {name} en plein ecran",
      selectPhotoAria: "Selectionner la photo",
      deselectPhotoAria: "Deselectionner la photo",
      liveBadge: "LIVE",
      setRatingAria: "Definir la note a {value}",
      removeFavorite: "Retirer des favoris",
      addFavorite: "Ajouter aux favoris",
      unarchive: "Desarchiver",
      archive: "Archiver",
      toggleFavoriteAria: "Basculer favori",
      toggleArchiveAria: "Basculer archivage",
      myPhotoBadge: "Ma photo",
      unknownMake: "Marque inconnue",
      unknownCamera: "Appareil inconnu",
      unknownDimensions: "Dimensions inconnues",
      loadingCachedMetadata: "Chargement des metadonnees en cache...",
