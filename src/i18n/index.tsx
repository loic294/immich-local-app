...
const RESOURCES: Record<AppLocale, TranslationTree> = {
  "en-CA": {
    ...
    localChanges: {
      title: "Local File Changes Detected",
      subtitle: "Review deleted or modified local files and choose which changes to apply.",
      applyErrorTitle: "Some changes could not be applied on the server.",
      moreErrors: "...and {count} more errors.",
      empty: "No pending local file changes.",
      deletedBadge: "File deleted locally",
      outcomeDeleted: "Will be moved to Deleted",
      outcomeModified: "Description will be updated",
      skip: "Skip",
      applying: "Applying...",
      applySelected: "Apply Selected ({count})",
      applyAll: "Apply All Changes",
      close: "Close",
      detailSize: "Size: {previous} B -> {current} B",
      detailModified: "Modified: {previous} -> {current}",
      detailGeneric: "Detected local file change.",
      applyingOverlay: "Applying local changes...",
    },
    syncCard: {
      syncedCount: "{processed} / {total} photos synced",
  ...
  "fr-CA": {
    ...
    localChanges: {
      title: "Modifications de fichiers locaux détectées",
      subtitle:
        "Vérifiez les fichiers locaux supprimés ou modifiés et choisissez les modifications à appliquer.",
      applyErrorTitle: "Certaines modifications n'ont pas pu être appliquées sur le serveur.",
      moreErrors: "...et {count} erreur(s) de plus.",
      empty: "Aucune modification de fichier local en attente.",
      deletedBadge: "Fichier supprimé localement",
      outcomeDeleted: "Sera déplacé vers Supprimés",
      outcomeModified: "La description sera mise à jour",
      skip: "Ignorer",
      applying: "Application...",
      applySelected: "Appliquer la sélection ({count})",
      applyAll: "Appliquer toutes les modifications",
      close: "Fermer",
      detailSize: "Taille : {previous} o -> {current} o",
      detailModified: "Modifié : {previous} -> {current}",
      detailGeneric: "Modification de fichier local détectée.",
      applyingOverlay: "Application des modifications locales...",
    },
    syncCard: {
